...
- Wordmark: "MARGA" as spaced capitals in Outfit beside the mark, and a hairline hero "MARGA" set low on the home background, lit from above and fading into the aurora. The passcode page now matches — still aurora, frosted card, same logotype and hero word.
